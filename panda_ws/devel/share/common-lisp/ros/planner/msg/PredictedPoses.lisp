...
(cl:defmethod cl:initialize-instance :after ((m <PredictedPoses>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PredictedPoses)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner-msg:<PredictedPoses> is deprecated: use planner-msg:PredictedPoses instead.")))
...
(cl:defmethod layout-val ((m <PredictedPoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner-msg:layout-val is deprecated.  Use planner-msg:layout instead.")
  (layout m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <PredictedPoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner-msg:poses-val is deprecated.  Use planner-msg:poses instead.")
  (poses m))

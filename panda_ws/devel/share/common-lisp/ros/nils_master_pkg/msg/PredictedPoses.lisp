...
(cl:in-package nils_master_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <PredictedPoses>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PredictedPoses)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nils_master_pkg-msg:<PredictedPoses> is deprecated: use nils_master_pkg-msg:PredictedPoses instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PredictedPoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nils_master_pkg-msg:header-val is deprecated.  Use nils_master_pkg-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'layout-val :lambda-list '(m))
(cl:defmethod layout-val ((m <PredictedPoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nils_master_pkg-msg:layout-val is deprecated.  Use nils_master_pkg-msg:layout instead.")
  (layout m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <PredictedPoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nils_master_pkg-msg:poses-val is deprecated.  Use nils_master_pkg-msg:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PredictedPoses>)))
  ...
  "nils_master_pkg/PredictedPoses")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PredictedPoses)))
  "Returns string type for a message object of type 'PredictedPoses"
  "nils_master_pkg/PredictedPoses")

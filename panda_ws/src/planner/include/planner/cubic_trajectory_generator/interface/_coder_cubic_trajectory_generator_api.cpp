...
// File: _coder_cubic_trajectory_generator_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "cubic_trajectory_generator",                         // fFunctionName
                                    ...
                                    const mxArray **plhs)
{
  ...
  cubic_trajectory_generator(*wayPoints, *wayPointVels, *trajectory);
...
void cubic_trajectory_generator_atexit()
{
  ...
  cubic_trajectory_generator_xil_terminate();
  cubic_trajectory_generator_xil_shutdown();
...
//
// File trailer for _coder_cubic_trajectory_generator_api.cpp
//
// [EOF]
//
